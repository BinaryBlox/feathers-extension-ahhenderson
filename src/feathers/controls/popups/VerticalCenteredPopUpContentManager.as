...
package feathers.controls.popups
{
	...
	public class VerticalCenteredPopUpContentManager extends EventDispatcher implements IPopUpContentManager
	{
		...
		//////////////////////////////////
		//  START: Modified Feathers Code
		//////////////////////////////////
		protected var _defaultOverlayFunction:Function;
		
		public function get defaultOverlayFunction():Function {
			
			
			return this._defaultOverlayFunction;
		}
		
		public function get disableAutoClose():Boolean
		{
			return _disableAutoClose;
		}
		
		public function set disableAutoClose(value:Boolean):void
		{
			_disableAutoClose = value;
		}
		
		
		
		protected var _disableAutoClose:Boolean = false;
		
		/**
		 * @private
		 */
		public function set defaultOverlayFunction( value:Function ):void {
			
			if ( this._defaultOverlayFunction == value ) {
				return;
			}
			this._defaultOverlayFunction = value;
		 ...
		 */
		internal function defaultOverlayFactory():DisplayObject {
		...
		public function open(content:DisplayObject, source:DisplayObject):void
		{
			...
			if(defaultOverlayFunction){
				PopUpManager.addPopUp(this.content, true, true, defaultOverlayFunction);
			}else{
				PopUpManager.addPopUp(this.content, true, true);
			}
...
*/
		...
		protected function onCloseTouchOutOfBounds():void{
