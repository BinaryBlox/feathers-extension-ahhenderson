...
package feathers.extension.ahhenderson.controls.supportClasses
{
	...
	public class GroupedListDataViewPort extends FeathersControl implements IViewPort
	{
		...
		{
			// VZ_CHANGE: Created to dispose of renderers and associated events without null pointer exc.
			disposeRendererLogic();
		...
		// VZ_CHANGE: Created to dispose of renderers and associated events without null pointer exc.
		protected function disposeRendererLogic():void{
		...
		override protected function draw():void
		{
			...
			// VZ_CHANGE: Not adding this contraint caused null pointer.
			if(!_owner)
				return;
